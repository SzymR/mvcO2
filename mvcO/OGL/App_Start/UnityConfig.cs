...
namespace OGL.App_Start
{
    ...
    public class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            // Konfiguracja kontenetra Unity, aby wstrzykiwal w miejsce interfejsu IOglContext instancjê klasy OglContext
            // PerRequest - przy kazdym zadaniu zostanie utworzony nowy obiekt, a po zakonczeniu
            ...
            container.RegisterType<IAdminRepo, AdminRepo>(new PerRequestLifetimeManager());
